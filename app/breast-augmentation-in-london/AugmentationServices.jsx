...
const AugmentationServices = () => {
  ...
  return (
    ...
    <div className={`flex flex-col md:flex-row w-full justify-between mt-[2vh] md:min-h-[65vh] `}>
        ...
        <div className={`relative flex w-full h-[40vh] overflow-hidden bg-black `}>
        <Image object-fit="cover" fill={true} alt="" className={`flex w-full h-full  ease-in-out duration-500 object-cover hover:scale-125 transition cursor-pointer`} src={breast_fat2}></Image>
                <div className={`absolute w-full top-[10vh] left-[2vw] `}>
