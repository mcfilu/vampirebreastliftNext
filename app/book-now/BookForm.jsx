  ...
  return (
    <div className={`flex flex-col md:flex-row w-full  mt-[10vh] ]`}>
        <div className={`flex flex-col items-center  w-full md:w-1/2 border-r-2 border-gold1`}>
            <h2 className={`text-gold1 font-header mt-8 text-[6vh] text-center`}>Request a Callback</h2>
            <h2 className={`text-white font-main mt-8 text-[2.5vh] text-center w-9/12 `}>Give us your Name and Phone Number and we will call you back!</h2>
        ...
        <h2 className={`text-gold1 font-header mt-8 text-[6vh] text-center`}>Contact Clinic</h2>
        <h2 className={`text-white font-main mt-8 text-[2.5vh] text-center w-9/12 `}>Directly contact Dr.SW Clinics to schedule a consultation or obtain any information you may need.</h2>
